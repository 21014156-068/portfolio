...
export const projects = [
  ...
  {
    id: 7,
    title: "Vividhood Mobile App – Backend Integration",
    category: "Mobile Backend Integration",
    isFeatured: true,
    image: "/vividhood.png",
    description:
      "Integrated 30+ live API endpoints from a NestJS/PostgreSQL backend into a Flutter mobile app for both customers and providers. Replaced all mock data with real server responses, built secure authentication (phone OTP, Google, biometric), a real-time booking system, appointment management, favorites, referrals, loyalty wallet, notification badge, and full provider management tools (dashboard, calendar, services, staff, settings).",
    techStack: [
      "Flutter",
      "Dart",
      "NestJS",
    ...
    features: [
      "Phone OTP signup with multi-step verification",
      "Google Sign-In & biometric fingerprint login",
      "Real-time booking with live availability slots",
      "Customer appointment list with status filter & detail view",
      "Provider dashboard with manual booking creation",
      "Service & staff management with Cloudinary image uploads",
      "Favorites, referrals, loyalty wallet & notification badge",
      "Zero hardcoded data – fully synced with production backend",
    ],
    liveLink: "https://vividhood.com",
  },
  {
    id: 6,
    title: "Vividhood Website – Bug Fixing",
    category: "Full‑Stack Debugging & Maintenance",
    isFeatured: false,
    image: "/v1.png",
    description:
      "Resolved 12+ critical bugs across a live Next.js/NestJS platform, restoring stability and improving user experience. Fixes spanned routing, email localization, marketplace fairness, React hydration, API connectivity, admin financial integrity, verification flows, authentication, and Google OAuth. Delivered measurable improvements to reliability, security, and user satisfaction.",
    techStack: [
      "Next.js",
      "React",
      "TypeScript",
    ...
    features: [
      "Fixed 404 errors on English URLs via middleware rewrite strategy",
      "Synchronized email language delivery (Chinese/English)",
      "Implemented fair marketplace sorting with PostgreSQL RANDOM()",
      "Resolved React hydration mismatches on page refresh",
      "Audited and corrected API endpoints & CORS configuration",
      "Added conditional display of Stripe fees for walk‑in bookings",
      "Built dynamic email‑change flow during verification",
      "Implemented case‑insensitive login across the full stack",
      "Strengthened Google Auth with profile‑completion guard",
      "Added service visibility toggle (Eye icon) with real‑time sync",
    ],
    liveLink: "https://vividhood.com",
  },
];
